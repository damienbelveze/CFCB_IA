...
- Maîtriser les [concepts essentiels](concepts_essentiels.qmd) : LLM, RAG, fine-turning, tokens, entraînement, prompts, hallucinations, etc..  
- Utiliser les IAG pour générer du [code](generer_code.qmd), des [quiz](generer_quiz.qmd), pour trouver des idées...  
